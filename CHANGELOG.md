...
- Add claude-code-with-secretive-1password community profile

### Changed

- Merge pull request #92 from boost-rnd/fix-verbose-and-1password-profile

Fix --verbose flag, add Secretive + 1Password + Go community profile
- Merge pull request #97 from johnpyp/fix/landlock-allow-remove-dir

fix: include RemoveDir in Landlock write access for atomic dir rename()

### Fixed

- Resolve --verbose flag having no effect on log output
- Include RemoveDir in Landlock write access for atomic dir rename()
